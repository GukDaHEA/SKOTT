window.profile = {
    ...
    state : {
        ...
        changing : {
            ...
            failCallback : function(result, self, beforeState) {
                ...
                if ($.isNumeric(result.code)) {
                    ...
                    /*
                        IE8, 9�먯꽌�� apache�� max content size error媛� html臾몄꽌濡� �대젮�⑤떎.
                        Max Size Upload �먮윭濡� �좎텛�� �� �덉쑝��, 10硫붽� �댁긽�� �뚯씪�� �щ━�� 寃쎌슦媛� �쒕Ъ 寃껋씠誘�濡�
                        �쇱떆�곸씤 �먮윭濡� 泥섎━�쒕떎
                     */
        ...
        deleted : {
            ...
            _setDisability : function(self) {
                self._setDisabled(self.dom.$btnDelete);
                self._setEnabled(self.dom.$btnConfirm);
                self._setBtnConfirmDisability(self);
            }
        },
    ...
    _confirmClickEvent : function() {
        ...
        if (this.dom.$btnConfirm.hasClass("btn_disable")) {
            return;
        }
