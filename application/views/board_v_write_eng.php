...
<body>
	...
	<form method="post" enctype="multipart/form-data" action="/board_c_eng/board_v_write/<?php echo $url ?>" class="background">
<h1> Review Write </h1> <br>	
		<input type="text" name="board_subject" placeholder="Title" class = "text_subject" style="width: 500px;text-indent:5px;"> <br> <hr>
		<textarea name="board_contents" placeholder="Contents" class = "text_textarea" rows="18" cols="108" style="text-indent: 10px;padding-top: 20px; background-color: #eaf1f7;" ></textarea> <br><br>
		<input type="file" name="user_upload_file" />
		<input type="submit" name="board_submit" class = "btn btn-primary" value = "Write" style="background-color:#4d7e2b; width: 100px;"> 
		
		<div class="main-container">
      <input type="radio" id="green" class="switch" checked>
			<div class="demo">
				<h1 class="title">Try Star grade !</h1>
				...
				<div class="cssui-progress js-progress">
					...
					<span class="js-progress__value cssui-progress__value">0 </span>
				</div>
			</div>
		</div>
	</form>
