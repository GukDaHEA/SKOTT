    ...
    <div id="container">
        ...
        <form id="frmNIDLogin" name="frmNIDLogin" action="/login/authentication" method="post">
                <fieldset class="login_form">
                    ...
                    <div class="input_row" id="id_area">
                        <span class="input_box">
                            <input type="text" id="email" name="email" tabindex="7" class="int" maxlength="41" value="" placeholder="E-mail address">
                        </span>
                    </div>
                    <div class="input_row" id="pw_area">
                        <span class="input_box">
                            <input type="password" id="password" name="password" tabindex="8" class="int" maxlength="16" placeholder="Password" >
                        </span>
                        <div class="ly_v2" id="err_capslock" style="display:none;">
                            <div class="ly_box">
                                <p><strong>Caps Lock</strong>is on.</p>                         </div>
            ...
            <div class="position_a">
                <div class="find_info">
                   <!--  <a target="_blank" href="" onclick="try{nclks('log.searchid',this,event)}catch(e){}">아이디 찾기</a> <span class="bar">|</span> --> <a target="_blank" href="" onclick="try{nclks('log.searchpass',this,event)}catch(e){}">Forget password?</a> <span class="bar">|</span> <a href="/login/join">Join now!</a>               </div>
            </div>
