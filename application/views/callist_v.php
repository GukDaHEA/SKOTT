...
<style>
.input_row{float:left;position:relative;width:290px;height:150px;padding:10px 35px 10px 15px;border:solid 0px #dadada;border-radius:10px;background:#000;color:#fff;}
 .login_form{ border:0px;margin-top:0; width:100%;height:100%;}
