...
.join_from .error_ch{margin-bottom:0px}.ps_box{position:relative;display:block;height:27px;background:#fff url(https://static.nid.naver.com/images/join/pc/ico_join3_2x_20170202.png) 100% 0 no-repeat;-webkit-background-size:97px 900px;background-size:97px 900px}.join_from .lbl{font-size:15px;line-height:18px;position:absolute;z-index:9;top:5px;left:0;display:block;color:#999}.join_row .int{font-size:15px;position:relative;z-index:10;width:100%;height:16px;padding:6px 0;border:none;background:#fff;*position:absolute;*top:0;*left:0;apperance:none;-webkit-apperance:none}
...
.join_from .cell{display:table-cell;width:5px;padding-right:10px;text-indent:-999em;background:url(https://static.nid.naver.com/images/join/pc/ico_join3_2x_20170202.png) -94px -575px no-repeat;-webkit-background-size:97px 900px;background-size:97px 900px;*display:block;*float:left;*padding:0}
</style>
<body>
 <div id="wrap">
