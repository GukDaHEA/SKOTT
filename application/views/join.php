...
<body>
 <div id="wrap">
    ...
    <!-- header -->
    <div id="header">
        <h1><a href="/mains" class="h_logo">SKOTT</a></h1>
    </div>
    <!-- //header -->
