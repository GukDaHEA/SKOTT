...
<title> Detail Page - <?php echo $name; ?></title>
<style type="text/css">
...
<div class="container">
    <div class = "BoxA">
      <div class = "Box1">
        ...
        <div id="header2">
          <div class="Box1_2">
            <div id = "div_Info">
              <h1 style="color:#4d7e2b">Spot Information</h1>
              <div id="div_Title2">
                <h3><?php echo $name;?></h3>
              </div>
              <div id="div_Info2">
        ...
        <div id = "div_Map"></div>
          ...
          <div id= "div_taxiinfo">
            <div id="div_Address" style="text-align:center;font-size:5pt;">
              <br/><h2>
                            Estimated time  <div class= "totalTimeFun">: time</div>
                            Estimated distance  <div class= "totalDistanceFun">: Distance</div>
                            Estimated Fare  <div class= "taxiFareFun">: Fare</div> <br/>
                            ...
                            Departure : <input type="text" name="start" id="start" value="Your Position" readonly/> <br />
              ...
              <br/></h2>
                            ...
                            <button class="nopc" id="Btn">Call</button> <br />
            </div>
          </div>
          </form>
        </div>
    ...
    <button class = "positive ui button" onclick="location.href='/board_c_eng/board_v_eng/<?php echo $idx ?>'">Review</button>
  </div>
